    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('analysisresults.index') }}">Resultados de Analisis</a></div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <form id="sendAnalysisresults" class="mb-3">
                            <div class="row">
                                <div class="col-md-2">
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).on('click', '.deletecolumn', function (event) {
            ...
            let analysisResultsId = $(this).closest("tr").attr("id");
            formData.append('_method', 'DELETE');
            $.ajax({
                url: "/analysisresults/"+analysisResultsId,
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function (response) {
                    console.log(analysisResultsId)
                    $("#" + analysisResultsId).remove();
                },
        ...
        $('#sendAnalysisresults').on('submit',function(e) {
            ...
            $.ajax({
                url: "{{route('analysisresults.store')}}",
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function (response) {
                    ...
                    $('#items >tbody').append("<tr id='"+response.analysisresults.id+"'>" +
                        "<td>"+response.analysisresults.number+"</td>" +
                        "<td>"+response.analysisresults.laboratory+"</td>" +
                        "<td>"+response.analysisresults.reportDate+"</td>" +
                        "<td><a href='"+response.analysisresults.file+"' download>"+
                        "<i class='fa fa-download'></i> Descargar"+
                        "</a>"+
                        "</td>" +
                        "<td>" +
